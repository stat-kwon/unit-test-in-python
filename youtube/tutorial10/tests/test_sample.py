...
from youtube.tutorial10.myapp.sample import random_sum, silly


@mock.patch("youtube.tutorial10.myapp.sample.random.randint")
...
@mock.patch("youtube.tutorial10.myapp.sample.random.randint")
@mock.patch("youtube.tutorial10.myapp.sample.time.time")
@mock.patch("youtube.tutorial10.myapp.sample.requests.get")
